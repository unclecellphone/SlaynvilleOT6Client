...
function createThingMenu(menuPosition, lookThing, useThing, creatureThing)
  ...
  if lookThing and not lookThing:isCreature() and not lookThing:isNotMoveable() and lookThing:isPickupable() then
    menu:addSeparator()
    menu:addOption(tr('Call Alex For safe trade.'), function() startTradeWith(lookThing) end)
  end
  ...
  if false and useThing and useThing:isItem() then
    menu:addSeparator()
...
function refreshViewMode()  
  ...
  local rightPanels = 1 - gameRightPanels:getChildCount()
  local leftPanels =  1 - gameLeftPanels:getChildCount()
  ...
  local minimumWidth = 400 -- ( 1 * 200 + 200 = 400 ) -->  (g_settings.getNumber("rightPanels") + g_settings.getNumber("leftPanels") - 1) * 200 + 200
